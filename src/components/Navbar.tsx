        ...
        <div className="flex justify-between items-center h-20">
          ...
          <Link href="/" className="flex items-center gap-3 group">
            ...
            <div className="flex flex-col">
              <span className="font-heading font-bold text-lg leading-tight text-brand-navy transition-colors">
                THE KAKADU
              </span>
          ...
          <div className="hidden lg:flex items-center gap-8">
            ...
            <Link
              href="/contact"
              className="relative ml-2 px-5 py-2.5 bg-brand-green text-white font-semibold text-sm rounded-lg hover:bg-brand-greenDark transition-all duration-300 flex items-center gap-2"
              style={{ boxShadow: "0 0 20px rgba(27, 174, 112, 0.3)", animation: "helpdesk-glow 2s ease-in-out infinite" }}
            >
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M18.364 5.636l-3.536 3.536m0 5.656l3.536 3.536M9.172 9.172L5.636 5.636m3.536 9.192l-3.536 3.536M21 12a9 9 0 11-18 0 9 9 0 0118 0zm-5 0a4 4 0 11-8 0 4 4 0 018 0z" />
              </svg>
              <span>Helpdesk</span>
              <span className="absolute -top-1 -right-1 w-2.5 h-2.5 bg-brand-green rounded-full border-2 border-white" style={{ animation: "helpdesk-pulse 2s ease-in-out infinite" }} />
            </Link>
